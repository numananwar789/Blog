...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('frontend_assets/assets/favicon.ico') }}" />
...
<body>
    ...
    <!-- Page Header-->
    <header class="masthead" style="background-image: url('frontend_assets/assets/img/home-bg.jpg')">
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <a href="#!"><img class="img-fluid" src="assets/img/post-sample-image.jpg"
                            alt="..." /></a>
